...
function getRegisterConfig(kind: ReturnType<typeof getProductKind>) {
  ...
  if (kind === 'editorial') {
    return {
      ...
      icon: FileText,
      title: 'Create your reader and writer profile',
      body: 'Join the journal to save articles, submit drafts, and get gentle reminders when new retreat stories publish.',
    }
  }
  if (kind === 'visual') {
    return {
      ...
      <main className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <section className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-stretch">
          ...
          <div className={`rounded-[2rem] p-8 ${config.panel}`}>
            ...
            <RegisterForm submitClassName={config.action} inputClassName={config.input} />
